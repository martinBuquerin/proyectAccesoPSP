...
<%
     List<Ofrece>  serv = (List<Ofrece>) session.getAttribute("servicios");
    
   String servi= serv.get(0).getServicioidServicio().getNombre();
    %>
    ...
    <body>
        <h2 class="text-center m-4 text-success bg-light rounded" ><%=serv.get(0).getServicioidServicio().getNombre()%></h5>
                ...
                <c:forEach var="servicio" items="${servicios}" varStatus="status">
                    ...
                    <div class="row border border-gray border-1 rounded-3 shadow bg-body rounded" style="width: 22rem; margin:5px">
                        <div class="col mt-2 ">
                            ...
                            <div class="row">
                                <div class="col mt-2 ml-2">
                                    <p>${servicio.usuarioEmail.nombreEmpresa}</p>
                                    <p>${servicio.usuarioEmail.descripcionEmpresa}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col mt-2 pt-4" >
                            ...
                            <img th:src="@{'data:image/jpeg;base64,''..base64_encode${servicio.usuarioEmail.imagen}.'}">
