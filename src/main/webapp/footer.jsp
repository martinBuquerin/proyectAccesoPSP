...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
  ...
  <footer class="w-100  d-flex  align-items-center justify-content-center flex-wrap bg-light fixed-bottom">
    <div class="container p-1">
      <div class="row row-cols-4 justify-content-center">
        ...
        <div class="col m-2 ">
          <h5 class="text-uppercase mb-0">Sobre miWeb.</h5>
          <ul class="list-unstyled mb-0" style="padding-top: 1em;">
            <li>
        ...
        <div class="col m-2">
          <h5 class="text-uppercase mb-0">miWeb.</h5>
