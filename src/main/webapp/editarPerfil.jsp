                ...
                <form>
                    <div class="row" style="height: 320px ; padding-left: 14em;">
                        <div class="col mb-3">
                            ...
                            <input type="text" class="form-control" id="servicio" aria-describedby="emailHelp">

                        </div>
                        <div class="col mb-3">
                            <label for="exampleInputPassword1" class="form-label">¿Dónde lo quieres?</label>
                        ...
                        <div class="col mb-3">
                            <label for="exampleInputPassword1" class="form-label" style="height: 20px; width: 147px;"><!----></label>
                            <button type="submit" class="btn btn-primary"   style="margin-top: 2em;"> <a href="buscar?accion=listar" class="btn btn-primary">Buscar</a></button>
                        </div>
                    </div>
