        ...
        <main>
            ...
            <body>
                ...
                <section class="d-flex flex-column  pt-5  text-center mx-4 m-auto" id="busqueda">
                    <h1 class="p-3 fs-2 border-top border-3 pt-5 pb-2"> Encuentra<span class="text-success"> Servicios y Profesionales</span></h1>
                    ...
                    <form class="form" action="usuario?accion=buscarServicio" method="POST">
                        <div class="row mt-2 mb-3">
                            <div class="col  ">
                                <h2 class="text-dark  mb-4" id="typewriter"></h2>
                            </div>
                ...
                <!--Tarjetas-->
                <section class="d-flex flex-column  pt-5 text-center mx-auto " style="padding-top:60px;padding-bottom:60px;">
                    <p class="border-top border-3 mx-4"></p>
                    <div class="row w-75  mx-auto justify-content-center " id="tarjetas">
                ...
                <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
                <script src="recursos/javaType.js"></script>
            </body>
