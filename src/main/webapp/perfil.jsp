        ...
        <main>
            ...
            <body>
                ...
                <div class="container-fluid w-75">
                    ...
                    <div class="row justify-content-center" style="margin-left: 12rem; margin-bottom: 5rem; margin-top: 7rem;">
                            ...
                            <div class="card mb-3 w-75">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 text-secondary">
                                            <c:out value="${usuario.nombreEmpresa}"/>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 text-secondary">
                                            <c:out value="${usuario.descripcionEmpresa}"/>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="usuario?accion=editarPerfil&id=${usuario.email}" class="btn btn-success float-end"  >Editar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
